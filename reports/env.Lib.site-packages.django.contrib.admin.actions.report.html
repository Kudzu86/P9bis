      ...
      <div id="page">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.contrib.admin.actions.source.html#l27">
                  <tt><i>27</i> <span class="sd">    Next, it deletes all selected objects and redirects back to the change list.</span></tt>
               </a>
            </li>
            </ul>
         </li>

...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\utils\functional.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.utils.functional.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\django\utils\functional.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.utils.functional.source.html#l35">
                  <tt><i>35</i>                 <span class="s2">&quot;Cannot assign the same cached_property to two different names &quot;</span></tt>
               </a>
            </li>
            </ul>
         </li>

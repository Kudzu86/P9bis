...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\contrib\auth\base_user.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.contrib.auth.base_user.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.contrib.auth.base_user.source.html#l72">
                  <tt><i>72</i>         <span class="nb">setattr</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">USERNAME_FIELD</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">normalize_username</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">get_username</span><span class="p">()))</span></tt>
               </a>
            </li><li>
               
               <p>Line too long (86 > 79 characters):</p>
               
               <a href="env.Lib.site-packages.django.contrib.auth.base_user.source.html#l143">
                  <tt><i>143</i>         <span class="n">key_salt</span> <span class="o">=</span> <span class="s2">&quot;django.contrib.auth.models.AbstractBaseUser.get_session_auth_hash&quot;</span></tt>
               </a>
            </li>
            </ul>
         </li>
